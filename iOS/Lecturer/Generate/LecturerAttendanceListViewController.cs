...
{
    public partial class LecturerAttendanceListViewController : UITableViewController
    {
        ...
        public LecturerAttendanceListViewController(IntPtr handle) : base(handle)
        {
        ...
        private void CheckMethod() {
            ...
            {
                for (int i = 0; i < attendanceTableViewItems.Count; i++)
                {
                    if (attendanceTableViewItems[i].AdmissionId == "No student submit ATS yet.")
                    {
        ...
        public class TableSource : UITableViewSource
        {
            ...
            public override UITableViewCell GetCell(UITableView tableView, NSIndexPath indexPath)
            {
                ...
                if (cell == null)
                {
                    ...
                    for (int i = 0; i < attendanceTableViewItems.Count; i++)
                    {
                        if (attendanceTableViewItems[i].AdmissionId.Equals("No student submit ATS yet."))
                        {
